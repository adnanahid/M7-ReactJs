    ...
    <>
      ...
      <section className="relative bg-gray-900 text-white">
        ...
        <div className="container relative z-10 flex flex-col items-center py-32 md:w-8/12 mx-auto">
          ...
          <div className="flex space-x-4">
            ...
            <button className="btn text-white btn-outline rounded-3xl">Our Feedback</button>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto py-16 px-6 md:w-8/12">
        ...
        <p className="text-center text-gray-600 mb-4">
          ...
          vulputate netus pharetra rhoncus. Eget urna volutpat curabitur elementum mauris aenean neque.
        </p>
      </section>
    </>
  );
